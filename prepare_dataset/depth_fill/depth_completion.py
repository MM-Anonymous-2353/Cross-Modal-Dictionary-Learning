...
from prepare_dataset.depth_fill import depth_map_utils
from prepare_dataset.depth_fill import vis_utils



def DepthFill(data_path, outputs_dir):
    ...
    #     '/test/datasets/cityscapes/disparity_trainvaltest/disparity')


    input_depth_dir = os.path.expanduser(data_path)

    # for type_file in input_depth_dir:
    #     type_file_path = os.path.join(input_depth_dir, type_file)
    #     for sub_file_name in type_file_path:
    #         sub_file_path = os.path.join(type_file_path, sub_file_name)
