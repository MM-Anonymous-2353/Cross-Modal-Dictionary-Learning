...
if __name__ == '__main__':
    ...
    for i, meta in tqdm(enumerate(SUNRGBDMeta)):
        ...
        label_npy = os.path.join(real_dir, 'label/label.npy')
        
        label_path_full = os.path.join(output_path, 'SUNRGBD', label_npy)
        ...
        label_img = np.load(label_path_full)
        label_path = imageio.imwrite(os.path.join(output_path, 'SUNRGBD', os.path.join(real_dir, 'label/label.png')), label_img)
        ...
        if meta_dir in split_train:
            ...
            label_dir_train.append(os.path.join('SUNRGBD', os.path.join(real_dir, 'label/label.png')))
        else:
            ...
            label_dir_test.append(os.path.join('SUNRGBD', os.path.join(real_dir, 'label/label.png')))
