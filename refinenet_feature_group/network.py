...
from .backbone.mobilenetv2 import mbv2
from .backbone.resnet import rf_lw50, rf_lw101, rf_lw152


def get_segmenter(
    enc_backbone, enc_pretrained, num_classes, pre_ckpt,
):
    ...
    if enc_backbone == "50":
        ...
        return rf_lw152(num_classes, imagenet=enc_pretrained, pre_ckpt=pre_ckpt)
